...
Start the Flask server for live streaming and analytics:
...
- **Analytics API**: http://localhost:5000/analytics
- **Dashboard**: http://localhost:5000/ (if templates are configured)
...
### GET /analytics
Returns current passenger counts:
```json
{
  "IN": 45,
  "OUT": 32,
